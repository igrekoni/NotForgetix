package org.alfaseo.notforgetix.database;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "notforgetix_database";
    ...
    private static final String TASKS_TABLE_CEATE_SCRIPT = "CREATE TABLE"
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(TASKS_TABLE_CEATE_SCRIPT);
    }
